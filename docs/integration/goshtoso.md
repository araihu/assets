...
Use the public `v0.2.3` [immutable Git tag](https://github.com/araihu/assets/tree/v0.2.3),
...
`release.json`. `v0.1.1` remains the published promoted default and `v0.2.1`
